<template>
	<div class="overflow-hidden rounded-xl shadow-md w-full">
		<img
		...
		<div class="flex flex-col space-y-4 p-8">
			<span
				class="rounded-full px-2 py-1 bg-primary bg-opacity-5 text-primary w-min text-xs font-semibold uppercase"
				>New</span
			>
