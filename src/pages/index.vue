	...
	<div class="flex flex-col w-full">
		...
		<div class="py-16" id="where">
			<div class="container max-w-screen-lg">
				<div class="grid grid-cols-12 gap-y-8 gap-x-0 md:gap-x-8">
					<div
						class="col-span-12 row-start-2 md:row-start-1 md:col-span-6"
					>
						<div
					...
					>
						...
						<p class="leading-8 text-lg">
							Lorem ipsum dolor sit amet consectetur adipisicing
							elit. Impedit id debitis doloremque deleniti
							cupiditate. Facilis provident ipsam rem accusamus
							voluptatibus?
						</p>
					</div>
				</div>
